...
# TODO plan
I'm thinking of creating my own Linux inside a container (e.g. using VMware, VirtualBox) so that I can bring the system as a container over to many laptop without resetting all my personal settings and share with others if needed. But this seems to be a cumbersome idea, need to come up with more throughout idea. Docker maybe another alternative.
